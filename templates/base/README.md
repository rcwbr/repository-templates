# NEW_PROJECT<a name="new_project"></a>

[![GitHub Release](https://img.shields.io/github/v/release/NEW_ORG/NEW_PROJECT?logo=semver&style=flat-square)](https://github.com/NEW_ORG/NEW_PROJECT/releases/latest)
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/NEW_ORG/NEW_PROJECT/push-workflow.yaml?logo=github&style=flat-square)](https://github.com/NEW_ORG/NEW_PROJECT/actions/workflows/push-workflow.yaml?query=branch%3Amain)
...
`SECRET_PREFIX_DEVCONTAINER_INITIALIZE` (see
...
For use with Codespaces, the `SECRET_PREFIX_DEVCONTAINER_INITIALIZE` token (see
